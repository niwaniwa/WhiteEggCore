...
public class WhiteEggTwitterCommand extends WhiteEggCoreBaseCommandExecutor implements ConsoleCancellable {
    ...
    public WhiteEggTwitterCommand() {
        if (WhiteEggCore.getConf().useTwitter()) {
            CommandFactory.newCommand(WhiteEggCore.getInstance(), WhiteEggCore.msgPrefix, commandName, Arrays.asList("tw"), null, null, permission, WhiteEggCore.getInstance(), null);
        }
    }
