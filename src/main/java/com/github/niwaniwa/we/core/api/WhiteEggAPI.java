...
public abstract class WhiteEggAPI {
     ...
     */
    public static List<WhitePlayer> getOnlinePlayers() {
     ...
     */
    public static void RankBroadcastMessage(Rank rank, String message) {
        instance.RankBroadcastMessage(rank, message);
    }
     ...
     * @return WhitePlayer
     */
    public static WhitePlayer getPlayer(String name) {
     ...
     */
    public static WhitePlayer getPlayer(UUID uuid) {
     ...
     * @return WhitePlayer プレイヤー
     */
    public static WhitePlayer getPlayer(Player player) {
    ...
    public static boolean registerToggle(Plugin plugin, String tag, String permission,
        ...
        return instance.registerToggle(plugin, tag, permission, custam, toggles, isHide);
    }
